...
export const ProgressBarTrack = forwardRef<
  HTMLDivElement,
...
>((props, ref) => {
  ...
  return (
    <div
      ...
      {...otherProps}
      {...trackProps}
      style={{ ...style, ...trackProps.style }}
    />
  );
});
ProgressBarTrack.displayName = 'ProgressBarTrack';

export interface ProgressBarRangeProps
  extends React.HTMLAttributes<HTMLDivElement> {
  stepIndex?: number;
}

export const ProgressBarRange = forwardRef<
  HTMLDivElement,
...
>((props, ref) => {
  ...
  return (
    <div
      ...
      {...otherProps}
      {...stepData?.stepProps}
      style={{ ...style, width: stepData?.width }}
    />
  );
});

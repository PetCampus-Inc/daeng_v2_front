      ...
      >
        ...
        <div className='relative'>
          ...
          <Tabs defaultValue='기본정보'>
            <TabsList scrollable className='sticky top-[56px] z-10 bg-white'>
              ...
              <div className='mb-12 mt-8 flex flex-col gap-12 px-4'>
                ...
                <div>
                  <div className='mb-1 flex items-center justify-between'>
                    ...
                    <span className='body2-bold text-neutral-500'>
                      전화걸기
                    </span>
                  </div>
                    ...
                    <div>
                      ...
                      <div className='bg-primitive-neutral-50 flex flex-col gap-3 rounded-lg p-4'>
                        ...
                        <div className='grid grid-cols-3'>
                          ...
                          <span className='body2-regular text-center'>
                            15회
                          </span>
                          <span className='body2-regular text-right'>
                            720,000원
                    ...
                    {Array.from({ length: 10 }).map((_, index) => (
                      ...
                      >
                        ...
                        <p className='body2-regular text-text-secondary mb-[15px] line-clamp-2'>
                          바우라움 유치원 내돈내산 이용후기를 가져왔어요 하핫
                          우리 뚜비는 바우라움만 가면 폭식을 한답니다 간식도
                          같이 챙겨줬는데 다
                        </p>

...
import { GUARDIAN_KINDERGARTEN_NEWS_NEW_BADGE_MS } from '@views/guardian-kindergarten-news-page/model/guardianKindergartenNews';
 ...
 */
function formatGuardianKindergartenNewsPublishedAt(publishedAt: Date, now = new Date()) {
...
function isGuardianKindergartenNewsNewBadge(publishedAt: Date, now = new Date()) {

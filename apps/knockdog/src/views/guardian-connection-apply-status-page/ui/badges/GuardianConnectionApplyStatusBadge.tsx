...
import { GuardianConnectionApplyDisconnectedBadge } from '@views/guardian-connection-apply-status-page/ui/badges/GuardianConnectionApplyDisconnectedBadge';
...
function GuardianConnectionApplyStatusBadge({ status }: GuardianConnectionApplyStatusBadgeProps) {
  switch (status) {
    ...
    case GUARDIAN_CONNECTION_APPLY_STATUS.ACTIVE:
    ...
    case GUARDIAN_CONNECTION_APPLY_STATUS.DISCONNECTED:
      return <GuardianConnectionApplyDisconnectedBadge />;

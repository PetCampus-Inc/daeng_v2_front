...
const privacyConsentPolicySections = [
  {
    title: '수집·이용 항목:',
    items: [
      '필수 : 보호자 정보(이름, 성별, 연락처, 주소), 반려견 정보(이름, 보호자와의 관계, 견종, 몸무게, 성별)',
      '선택 : 보호자 상세 주소·비상연락처, 반려견 정보(태어난 해, 중성화 여부, 사진)',
      '연결 신청 정보: 신청 유치원, 신청 일시, 신청 상태, 승인/거절 처리 결과, 연결 상태',
      '연결 후 생성 정보: 등하원 기록, 알림장, 사진 등 유치원 운영 기록',
    ],
    note: '※ 비상연락처에 본인이 아닌 다른 사람의 연락처를 입력하는 경우, 사전에 해당 본인의 동의를 받아야 하며 이에 대한 책임은 입력한 보호자에게 있습니다.',
  },
  {
    title: '수집·이용 목적:',
    items: [
  ...
  {
    title: '제공 대상:',
    items: ['연결 신청한 해당 유치원의 원장', '같은 유치원에 연결된 보호자'],
    nestedItem: {
      parentIndex: 1,
      text: '단, 재원 기간 중 공용 앨범에 게시된 운영 기록에 한함',
    },
  },
  {
    title: '보유·이용 기간:',
    items: ['유치원 연결 종료 후 3년', '단, 관련 법령 또는 내부 보관 기준에 따라 보관이 필요한 정보는 해당 기간 동안 보관'],
  },
] satisfies readonly PrivacyConsentPolicySection[];

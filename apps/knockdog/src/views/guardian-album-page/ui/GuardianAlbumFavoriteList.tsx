...
import { GuardianAlbumFavoriteDaySection } from '@views/guardian-album-page/ui/GuardianAlbumFavoriteDaySection';
  ...
  return (
    ...
    >
      <div className='flex w-full flex-col gap-5 px-4 py-5'>
        {days.map((day) => (
          <GuardianAlbumFavoriteDaySection key={day.dateKey} day={day} />
        ))}
        {hasNextPage ? (

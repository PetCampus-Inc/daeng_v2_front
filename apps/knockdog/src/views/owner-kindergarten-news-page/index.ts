...
export { OwnerKindergartenNewsWritePage } from './ui/OwnerKindergartenNewsWritePage';
export { OwnerKindergartenNewsSearchPage } from './ui/OwnerKindergartenNewsSearchPage';

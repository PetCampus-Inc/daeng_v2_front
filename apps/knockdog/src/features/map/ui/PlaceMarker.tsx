  ...
  return (
    <div className='relative select-none' onClick={onClick}>
      ...
      >
        <p
          className={cn(
            'body2-bold text-text-primary whitespace-nowrap',
        ...
        <div className='gap-x0_5 flex items-center'>
          <span
            className={cn(
              'text-text-tertiary caption1-semibold',
              selected && 'text-text-secondary-inverse'
            )}
          >
            {distance}km
          </span>
          <Icon
            icon='BookmarkFill'
            className={cn(
              'text-fill-secondary-700 size-x4',
              selected && 'text-text-primary-inverse'
            )}
          />
          <Icon
      ...
      >
        <path
          className={cn(
            'stroke-fill-secondary-700 fill-fill-secondary-0',
            selected && 'fill-fill-secondary-700'
          )}

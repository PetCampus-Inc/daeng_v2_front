...
import { OPEN_STATUS_MAP } from '../model/constants';
import type { DogSchoolWithMeta } from '../model/mock';

interface DogSchoolDetailProps extends Omit<DogSchoolWithMeta, 'images'> {
  operationDescription: string;
}

export const DogSchoolDetail = ({
  title,
  ctg,
  dist,
  roadAddress,

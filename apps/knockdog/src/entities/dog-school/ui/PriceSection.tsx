    ...
    <div className='mb-12 mt-8 flex flex-col gap-12 px-4'>
      ...
      <div>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <div>
            <span className='body1-bold mb-3 inline-block'>Aqua Dog Fitness</span>
          ...
          <div>
            <span className='body1-bold mb-3 inline-block'>Private Personal Lesson</span>
          ...
          <div>
            <span className='body1-bold mb-3 inline-block'>Private Group Lesson</span>
